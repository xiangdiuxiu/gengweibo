...
<body><div class='page' style="margin-top: 150px;width: 790px;padding: 5px 10px 15px 10px;">
...
<li>无须专门在本程序中注册帐户，直接连接即可使用(oauth方式)，目前支持网易、腾讯、新浪和搜狐微博。连接进入系统后，还可以在“我的账户”里面设置连接更多的账户哦。</li>
